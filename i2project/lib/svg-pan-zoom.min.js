...
// changed preventMouseEventsDefault:0
//search for "//added code" for reset map calls
...
, _createZoomReset: function(instance){
    ...
    resetPanZoomControl.addEventListener('click', function() {instance.getPublicInstance().reset();
      //added code
        p.draw('all');  var mapObject = document.getElementById('map').contentDocument;
